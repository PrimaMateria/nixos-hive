...
in
  nixpkgs.writeTextFile {
    name = "matrix-wechat-config.yaml";
    text = builtins.toJSON {
      ...
      appservice = {
        ...
        database = {
          ...
          uri = "postgres://synapse:synapse@synapse-db/matrix-wechat?sslmode=disable";
        ...
        # Authentication tokens for AS <-> HS communication. Autogenerated; do not modify. //TODO
      ...
      bridge = {
        ...
        listen_secret = secrets.matrix.synapse.wechat_agent_key;
        ...
        double_puppet_server_map = {
          "primamateria.ddns.net" = "https://matrix.primamateria.ddns.net";
        };
        ...
        login_shared_secret_map = {
          "primamateria.ddns.net" = secrets.matrix.synapse.registration_shared_secret;
        };
        ...
        #     mxid - Specific user
        permissions = {
          "primamateria.ddns.net" = "user";
          "@primamateria:primamateria.ddns.net" = "admin";
        };
      };
